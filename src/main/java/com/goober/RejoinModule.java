...
public class RejoinModule extends Module {
    ...
    public void onActivate() {
        ...
        mc.getNetworkHandler().getConnection().disconnect(new net.minecraft.text.LiteralText("Reconnecting...") {});
        ChatUtils.info("Reconnecting in " + delay.get() + "s");
    }
